...
autoplot(pca, data=CHAVA_ECG, colour="Infection", size=4) + 
  scale_color_manual(values=c("darkgreen","red")) + theme_bw()
autoplot(pca, data=CHAVA_ECG, colour="Sex", size=4) + theme_classic()
ggsave("~/Library/CloudStorage/OneDrive-JohnsHopkins/Dr.GIlman/CHAVA_RNAseq/Deliverables/Manuscript/Figures/SexPCA.pdf")


autoplot(pca, data=CHAVA_ECG, colour="PCA", size=4) + theme_classic() + scale_color_manual(values=c("purple","darkgrey"))
ggsave("~/Library/CloudStorage/OneDrive-JohnsHopkins/Dr.GIlman/CHAVA_RNAseq/Deliverables/Manuscript/Figures/BatchEffect.pdf")

autoplot(pca, data=CHAVA_ECG, colour="ECG", size=4) + 
  scale_color_manual(values=c("#498655","#911434","#299AAF"))+ theme_bw()
autoplot(pca, data=CHAVA_ECG, colour="AgeCategory", size=4) + 
  scale_color_manual(values=c("#9EBCDA", "#8C6BB1", "#810F7C", "#4D004B"))+ theme_bw()

autoplot(pca, data=CHAVA_ECG, colour="Batch", size=4) +
  scale_color_brewer(palette = "Set2")+ theme_bw()
autoplot(pca, data=CHAVA_ECG, colour="RIN", size=4) +
  scale_color_brewer(palette = "Set2")+ theme_bw()
...
ggsave("~/Library/CloudStorage/OneDrive-JohnsHopkins/Dr.GIlman/CHAVA_RNAseq/Deliverables/Manuscript/Figures/Infection.pdf")
...
ggsave("~/Library/CloudStorage/OneDrive-JohnsHopkins/Dr.GIlman/CHAVA_RNAseq/Deliverables/Manuscript/Figures/Origin.pdf")
...
ggsave("~/Library/CloudStorage/OneDrive-JohnsHopkins/Dr.GIlman/CHAVA_RNAseq/Deliverables/Manuscript/Figures/AHA_Category.pdf")
...
ggsave("~/Library/CloudStorage/OneDrive-JohnsHopkins/Dr.GIlman/CHAVA_RNAseq/Deliverables/Manuscript/Figures/AgeCategory.pdf")
